document.addEventListener('DOMContentLoaded', function() {
    const riddles = [
        ...
        { question: "When it comes to devices that save lives, my standards are the guide. Which schedule am I?", answer: "Schedule II" },
        { question: "I list drugs that can form habits, requiring strict control. Identify me.", answer: "Schedule X" },
        { question: "I ensure the colors in your medicines are safe and sound. Which schedule am I?", answer: "Schedule VI" },
        { question: "I regulate the standards for products that are biological. What schedule am I?", answer: "Schedule XI" }
    ];
